...
import com.eeepay.zzq.demo.lib_common.utils.ABPixelUtil;


public class CustomDialog extends Dialog {
	private View _view,line_view,line_b_view;
	...
	private int mode;
	private boolean isDismissOnclick =  true;//在点击按钮后是否隐藏， 默认是
	...
	public CustomDialog(Context context , int theme, int mode) {
		...
		line_view = _view.findViewById(R.id.line_view);
		line_b_view = _view.findViewById(R.id.line_b_view);
	...
	private void showView() {
		line_b_view.setVisibility(View.VISIBLE);
	...
	public CustomDialog setMsgGravity(int gravity) {
	...
	public boolean isDismissOnclick() {
		return isDismissOnclick;
	}

	public CustomDialog setDismissOnclick(boolean dismissOnclick) {
