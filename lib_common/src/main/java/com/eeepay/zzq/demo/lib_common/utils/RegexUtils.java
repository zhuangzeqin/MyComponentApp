...
import com.eeepay.zzq.demo.lib_common.constant.RegexConstants;
...
public final class RegexUtils {
    ...
    /**
     * 讲类所在的包名转换为路径
     * com.eeepay.cn.demo.TestClass
     * /com/eeepay/cn/demo/TestClass
     *
     * @param clssName
     * @return
     */
    public static String classToPath(@NonNull final String clssName) {
        if (TextUtils.isEmpty(clssName)) {
            throw new IllegalStateException("===> clssName is null,you can must implement <===");
        }
        StringBuffer buffer = new StringBuffer("/");
        buffer.append(clssName.replace(".", "/"));
